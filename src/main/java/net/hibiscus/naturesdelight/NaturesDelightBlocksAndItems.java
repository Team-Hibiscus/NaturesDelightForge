...
public class NaturesDelightBlocksAndItems {
    ...
    public static final DeferredItem<ConsumableItem> MANAKISH_SLICE_ITEM = registerItem("manakish_slice", () -> new ConsumableItem(ModItems.foodItem(MANAKISH_SLICE)));
    ...
    public static final DeferredItem<ConsumableItem> ALFREDO_PASTA_ITEM = registerItem("alfredo_pasta", () -> new ConsumableItem(ModItems.bowlFoodItem(ALFREDO_PASTA)));
    public static final FoodProperties TURNIP_TAGINE = (new FoodProperties.Builder()).nutrition(12).saturationModifier(0.70f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT, FoodValues.MEDIUM_DURATION, 0), 1.0F).build();
    public static final DeferredItem<ConsumableItem> TURNIP_TAGINE_ITEM = registerItem("turnip_tagine", () -> new ConsumableItem(ModItems.bowlFoodItem(TURNIP_TAGINE)));
    public static final DeferredItem<ConsumableItem> COCONUT_SAUCE_ITEM = registerItem("coconut_sauce", () -> new ConsumableItem(ModItems.bowlFoodItem(FoodValues.TOMATO_SAUCE)));
    ...
    public static final DeferredItem<ConsumableItem> SWEET_AND_SAVORY_SAUTE_ITEM = registerItem("sweet_and_savory_saute", () -> new ConsumableItem(ModItems.bowlFoodItem(SWEET_AND_SAVORY_SAUTE)));
    public static final FoodProperties FAFARU = (new FoodProperties.Builder()).nutrition(14).saturationModifier(0.8f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT, FoodValues.LONG_DURATION, 0), 1.0F).build();
    public static final DeferredItem<ConsumableItem> FAFARU_ITEM = registerItem("fafaru", () -> new ConsumableItem(ModItems.bowlFoodItem(FAFARU)));
    ...
    public static final DeferredItem<ConsumableItem> COCONUT_PANCAKES_ITEM = registerItem("coconut_pancakes", () -> new ConsumableItem(ModItems.bowlFoodItem(COCONUT_PANCAKES)));
    public static final FoodProperties COCONUT_BREAD = (new FoodProperties.Builder()).nutrition(8).saturationModifier(0.6f).build();
    public static final DeferredItem<ConsumableItem> COCONUT_BREAD_ITEM = registerItem("coconut_bread", () -> new ConsumableItem(ModItems.foodItem(COCONUT_BREAD)));
    ...
    public static final DeferredItem<ConsumableItem> COCADA_ITEM = registerItem("cocada", () -> new ConsumableItem(ModItems.foodItem(COCADA)));
